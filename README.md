...
- 깊이와 지역에 맞춰 가중 추첨되는 적 6종, NPC 3종, 사건 3종
...
전체 게이트는 무기·퀴즈·손상 저장 복구·저장 파일·탐사 경제·조우/전투 상태·밸런스·ESLint·프로덕션 빌드·런타임 자산을 검사한다. 세부 명령과 수동 검증 순서는 [CHECKLIST.md](./CHECKLIST.md), 현재 구현 상태는 [PROJECT_STATUS.md](./PROJECT_STATUS.md)에 기록한다.
