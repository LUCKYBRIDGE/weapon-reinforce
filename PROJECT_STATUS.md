...
- [ ] 1.2-05 실제 강화 경제 시뮬레이션 및 필요 시 소폭 튜닝

다음 구현 단계는 **1.2-05 실제 강화 경제 시뮬레이션**이다. 대성공 +2/+3, 복원 무기고, GOOD/PERFECT 혼합 타이밍과 퀴즈팩 보상 차이를 포함한 현실적인 완주 비용을 먼저 계측하고, 수치 조정은 그 결과가 필요성을 보여 줄 때만 최소 범위로 한다.
